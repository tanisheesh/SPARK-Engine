...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Radial vignette to fade out grid at edges */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        {/* Animated spark mark — draws in first */}
        <motion.div
        ...
        <motion.p
          ...
          style={{ color: '#9A9A9A' }}
        >
          Talk to your data in plain English. SPARK writes the SQL, runs it locally,
          and explains what it found — no dashboards to build, no engineers to wait for.
        </motion.p>
        ...
        <motion.div {...FADE_UP(2.2)} className="flex flex-col sm:flex-row items-center gap-3">
          <a
            href="#cta"
            className="px-6 py-2.5 rounded-md text-sm font-medium transition-colors duration-150"
